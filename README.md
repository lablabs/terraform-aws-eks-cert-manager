...
| <a name="module_cluster-issuer"></a> [cluster-issuer](#module\_cluster-issuer) | git::https://github.com/lablabs/terraform-aws-eks-universal-addon.git//modules/addon | v0.0.22 |
## Resources
...
| <a name="input_cluster_issuer_argo_helm_wait_kubectl_version"></a> [cluster\_issuer\_argo\_helm\_wait\_kubectl\_version](#input\_cluster\_issuer\_argo\_helm\_wait\_kubectl\_version) | Version of kubectl to use for ArgoCD Application wait job. Defaults to `1.33.0`. | `string` |
