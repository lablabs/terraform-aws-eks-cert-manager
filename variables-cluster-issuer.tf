...
variable "cluster_issuer_values" {
  type        = string
  default     = null
...
variable "cluster_issuer_argo_enabled" {
  type        = bool
  default     = null
...
variable "cluster_issuer_argo_helm_enabled" {
  type        = bool
  default     = null
...
variable "cluster_issuer_argo_project" {
  type        = string
  default     = null
...
variable "cluster_issuer_argo_spec" {
  type        = any
  default     = null
...
variable "cluster_issuer_argo_spec_override" {
  type        = any
  default     = null
...
variable "cluster_issuer_argo_operation" {
  type        = any
  default     = null
  description = "ArgoCD Application manifest operation parameter. Defaults to `{}`."
}

variable "cluster_issuer_argo_helm_values" {
  type        = string
  default     = null
...
variable "cluster_issuer_argo_kubernetes_manifest_field_manager_force_conflicts" {
  type        = bool
  default     = null
...
variable "cluster_issuer_argo_kubernetes_manifest_wait_fields" {
  type        = map(string)
  default     = null
...
variable "cluster_issuer_helm_package_verify" {
  type        = bool
  default     = null
...
variable "cluster_issuer_helm_keyring" {
  type        = string
  default     = null
...
variable "cluster_issuer_helm_wait" {
  type        = bool
  default     = null
...
variable "cluster_issuer_helm_wait_for_jobs" {
  type        = bool
  default     = null
...
variable "cluster_issuer_helm_disable_openapi_validation" {
  type        = bool
  default     = null
...
variable "cluster_issuer_depends_on" {
  type        = any
  default     = []
  description = "List of resources to wait for before installing ClusterIssuer. Typically used to force a dependency on another addon."
}
